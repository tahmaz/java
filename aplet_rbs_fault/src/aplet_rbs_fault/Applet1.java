...
public class Applet1 extends Applet {
    ...
    private void jbInit() throws Exception {
        ...
        jdbLabel1.setBounds(new Rectangle(4, 70, 242, 20));
        database1.setConnection(new ConnectionDescriptor("jdbc:odbc:MYodbc",
                "root", "some_pass", false, "sun.jdbc.odbc.JdbcOdbcDriver"));
